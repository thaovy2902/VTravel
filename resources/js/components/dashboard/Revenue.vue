<template>
  <a-card :bordered="false" :bodyStyle="{ padding: '16px' }" :headStyle="{ padding: '0 16px' }">
    <div class="header">
      <h3>Revenue</h3>
      <div>
        <a-select v-if="type === 'month'" v-model="month" placeholder="Chọn tháng" style="width:180px;margin-right:8px">
        ...
        <a-select v-if="type === 'quarter'" v-model="quarter" placeholder="Chọn quý" style="width:180px;margin-right:8px">
        ...
        <a-select placeholder="Chọn năm" v-model="year" style="width:180px;margin-right:8px">
