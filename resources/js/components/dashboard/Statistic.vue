<template>
  <a-row :gutter="{ xs: 8, sm: 16, md: 16, lg: 16 }">
    <a-col :sm="24" :md="12" :xl="6">
      <card-statistic title="Users" :loading="loadingStatistic">
        <a-tooltip title="Users" slot="action">
        ...
        <div slot="footer">
          <a-tooltip title="Since last month" slot="action">
            <a-icon :class="countUserDifference > 0 ? 'up' : 'down'" :type="countUserDifference > 0 ? 'caret-up' : 'caret-down'" />
            {{ countUserDifference > 0 ? "+" : "" }}{{ countUserDifference }} user
          </a-tooltip>
        </div>
      </card-statistic>
    </a-col>
    <a-col :sm="24" :md="12" :xl="6">
      <card-statistic title="Tours" :loading="loadingStatistic">
        <a-tooltip title="Tours" slot="action">
          <a-icon type="info-circle-o" />
        </a-tooltip>
        <div slot="total">
    ...
    <a-col :sm="24" :md="12" :xl="6">
      <card-statistic title="Orders" :loading="loadingStatistic">
